...
namespace Fifth
{
    ...
    public class FuncStack : IFuncStack
    {
        ...
        /// </summary>
        public FuncStack() => this.Stack = new Stack<FuncWrapper>();

        /// <summary>
        /// Gets a value indicating whether the stack is empty.
        /// </summary>
        /// <value><c>true</c> if this stack is empty; otherwise, <c>false</c>.</value>
        bool IFuncStack.IsEmpty => this.Stack.Count == 0;
        ...
        public FuncWrapper Pop() => this.Stack.Pop();

        /// <summary>
        /// Pushes a function onto the stack.
        /// </summary>
        /// <param name="funcWrapper">The function wrapper.</param>
        public void Push(FuncWrapper funcWrapper) => this.Stack.Push(funcWrapper);
    }
}