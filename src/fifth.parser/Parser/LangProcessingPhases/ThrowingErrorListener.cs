...
namespace fifth.parser.Parser
{
    public class ThrowingErrorListener<TResult> : IAntlrErrorListener<TResult>
    {
        ...
        public void SyntaxError(TextWriter output, IRecognizer recognizer, TResult offendingSymbol, int line, int charPositionInLine, string msg, RecognitionException e)
        {
