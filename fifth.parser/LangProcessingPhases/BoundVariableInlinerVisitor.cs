...
public class BindingsGathererVisitor : DefaultMutatorVisitor<BoundVariablesContext>
{
    public HierarchicalMap<string, AstNode> Bindings { get; set; } = new HierarchicalMap<string, AstNode>();
    ...
    public override FunctionDefinition ProcessFunctionDefinition(FunctionDefinition node, BoundVariablesContext ctx)
    {
        return node;
    }

    public override OverloadedFunctionDefinition ProcessOverloadedFunctionDefinition(OverloadedFunctionDefinition node, BoundVariablesContext ctx)
    {
        return node;
    }
