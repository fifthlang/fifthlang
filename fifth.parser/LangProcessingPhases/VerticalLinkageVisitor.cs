...
public class VerticalLinkageVisitor : IAstVisitor
{
    ...
    public void EnterDestructuringBinding(DestructuringBinding ctx) => EnterNonTerminal(ctx);

    public void EnterDestructuringDeclaration(DestructuringDeclaration ctx) => EnterNonTerminal(ctx);
    ...
    public void LeaveDestructuringBinding(DestructuringBinding ctx) => LeaveNonTerminal(ctx);

    public void LeaveDestructuringDeclaration(DestructuringDeclaration ctx) => LeaveNonTerminal(ctx);
