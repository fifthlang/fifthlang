...
- [x] 1. Scaffold Astro project and configure build tooling
  - [x] 1.1 Initialize Astro project under `/website`
  ...
  - [x] 1.2 Configure `astro.config.mjs` with site URL, integrations, and Fifth syntax highlighting
  ...
  - [x] 1.3 Create the Fifth TextMate grammar file (`website/fifth.tmLanguage.json`)
  ...
  - [x] 1.4 Create `public/` directory with static assets
...
- [x] 2. Define content collections and design tokens
  - [x] 2.1 Create content collection schemas (`src/content/config.ts`)
  ...
  - [x] 2.2 Write property test for content collection schemas (Property 9)
  ...
  - [x] 2.3 Create global CSS with design tokens (`src/styles/global.css`)
  ...
  - [x] 2.4 Create navigation configuration (`src/config/nav.ts`)
...
- [x] 3. Checkpoint — Verify project builds and schemas validate
...
- [x] 4. Build layout components
  ...
  - [x] 4.4 Create `TutorialLayout.astro`
...
- [x] 5. Build UI components
  - [x] 5.1 Create `Header.astro` and `Nav.astro`
  ...
  - [x] 5.6 Create `HeroSection.astro`
  ...
  - [x] 5.9 Create `SearchWidget.astro`
...
- [x] 6. Checkpoint — Verify components render in isolation
  - Ensure `astro build` succeeds with all components and layouts
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Create page routes
  - [x] 7.1 Create landing page (`src/pages/index.astro`)
  ...
  - [x] 7.2 Create documentation pages (`src/pages/docs/[...slug].astro`)
    - Use `DocLayout`
  ...
  - [x] 7.3 Create blog pages (`src/pages/blog/index.astro`, `src/pages/blog/[...slug].astro`)
  ...
  - [x] 7.7 Create custom 404 page (`src/pages/404.astro`)
    - Use `BaseLayout`
    - Provide navigation back to home and search option
    - _Requirements: 16.4_

- [x] 8. Migrate content from `docs/` to website content collections
  - [x] 8.1 Migrate Getting Started content
  ...
  - [x] 8.4 Migrate SDK reference content
  ...
  - [x] 8.5 Create placeholder documentation pages for sections without existing source
...
- [x] 9. Checkpoint — Verify full site builds with migrated content
...
- [x] 10. Implement search integration (Pagefind)
  - [x] 10.1 Install and configure Pagefind
...
- [x] 11. Create GitHub Actions deployment workflow
  - [x] 11.1 Create `.github/workflows/deploy-website.yml`
...
- [x] 12. Checkpoint — Full build and deploy pipeline verification
  - Ensure `npm run build && npx pagefind --site dist && npx vitest --run` succeeds locally
  - Ensure all tests pass, ask the user if questions arise.

- [x] 13. Write property-based tests against build output
  - [x] 13.1 Write property test for global navigation presence (Property 1)
  ...
  - [x] 13.2 Write property test for breadcrumb presence (Property 2)
  ...
  - [x] 13.3 Write property test for documentation heading anchors (Property 3)
    - **Property 3: Documentation heading anchors**
    - Parse every docs HTML file, verify all `h1`–`h6` elements have `id` attributes
    - **Validates: Requirements 4.4**

  - [x] 13.4 Write property test for tutorial metadata display (Property 4)
  ...
  - [x] 13.5 Write property test for blog post display completeness (Property 5)
  ...
  - [x] 13.6 Write property test for Fifth syntax highlighting (Property 6)
  ...
  - [x] 13.7 Write property test for copy-to-clipboard on code blocks (Property 7)
  ...
  - [x] 13.8 Write property test for long code block line numbers (Property 8)
  ...
  - [x] 13.9 Write property test for sitemap completeness (Property 10)
  ...
  - [x] 13.10 Write property test for meta tag presence (Property 11)
  ...
  - [x] 13.11 Write property test for semantic HTML structure (Property 12)
    - **Property 12: Semantic HTML structure**
    - Parse every HTML file, verify presence of `<header>`, `<nav>`, `<main>`, `<footer>`
    - **Validates: Requirements 13.3**

  - [x] 13.12 Write property test for clean URLs (Property 13)
  ...
  - [x] 13.13 Write property test for internal link integrity (Property 14)
  ...
  - [x] 13.14 Write property test for content readable without JavaScript (Property 15)
  ...
  - [x] 13.15 Write property test for no external CDN dependencies (Property 16)
...
- [x] 14. Write unit and example tests
  - [x] 14.1 Write unit tests for landing page structure
    - Verify hero section, three feature cards, two CTAs, and code snippet exist in `dist/index.html`
    - _Requirements: 1.1, 1.2, 1.3, 1.4_

  - [x] 14.2 Write unit tests for specific page existence and content
...
- [x] 15. Final checkpoint — All tests pass, site is complete
