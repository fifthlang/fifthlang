...
- [x] 1. Update build infrastructure (global.json and Directory.Build.props)
  - [x] 1.1 Update global.json to .NET 10 SDK
  ...
  - [x] 1.2 Update Directory.Build.props for .NET 10 compatibility
...
- [x] 2. Update project files with EnableNet10 multi-targeting removal (6 projects)
  - [x] 2.1 Replace conditional TargetFrameworks with single TargetFramework in all 6 projects
  ...
  - [x] 2.2 Merge conditional ItemGroups in Fifth.System.csproj and runtime-integration-tests.csproj
...
- [x] 3. Update project files with simple net8.0→net10.0 target change (13 projects)
  - [x] 3.1 Update TargetFramework in all 13 simple-target projects
...
- [x] 4. Remove conditional compilation directives from C# source files
  - [x] 4.1 Remove `#if NET10_0_OR_GREATER` blocks from KnowledgeGraphs.cs and Store.cs
  ...
  - [x] 4.2 Remove `#if NET10_0_OR_GREATER` wrappers from test files
...
- [x] 5. Checkpoint — Verify build infrastructure changes
...
- [x] 6. Update NuGet package dependencies to .NET 10-compatible versions
  - [x] 6.1 Update test infrastructure packages across all test projects
  ...
  - [x] 6.2 Update assertion and property-testing packages
  ...
  - [x] 6.3 Update Roslyn, reflection, and compiler tooling packages
  ...
  - [x] 6.4 Update runtime and framework packages
  ...
  - [x] 6.5 Update remaining packages
...
- [x] 7. Checkpoint — Restore and build with updated dependencies
...
- [x] 8. Update build scripts and tooling references
  - [x] 8.1 Update Justfile net8.0 output paths
  ...
  - [x] 8.2 Update AGENTS.md .NET version references
  ...
  - [x] 8.5 Update sample TaskListQuadStore README
...
- [x] 9. Update sample projects
  - [x] 9.1 Update sample global.json files
...
- [x] 10. Write property-based validation tests
  - [x] 10.1 Write property test: Sole net10.0 target with no net8.0 remnants
  ...
  - [x] 10.2 Write property test: EnableNet10 infrastructure fully removed
  ...
  - [x] 10.3 Write property test: Conditional compilation directives removed
  ...
  - [x] 10.4 Write property test: No framework-conditional ItemGroups
...
- [x] 11. Final validation — Full solution restore, build, and test
